...
<div id="nav" style="font-family: arial,sans-serif;">
  <div class="site__container">
    ...
    <div class="grid__container">
      ...
      <form action="ControllerServlet" method="post" class="form form--login">
      
      <input type="hidden" name="pagename" value="login.jsp">
    
<!--<div class="form__field" style="color: black;">LOGIN-->
<!--</div>-->
        <div class="form__field">
          <label class="fontawesome-user" for="username"><span class="hidden">Username</span></label>
          <input id="username" type="text"  name="username" class="form__input" placeholder="Username" required tabindex="1">
        </div>

        <div class="form__field">
          <label class="fontawesome-lock" for="password"><span class="hidden">Password</span></label>
          <input id="password" type="password" name="password" class="form__input" placeholder="Password" required tabindex="2">
        </div>
